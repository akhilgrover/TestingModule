...
public class ThresholdOpenOpp extends AbstractOpen
{

        public ThresholdOpenOpp()
        {
            this.paramCount=1;
        }

	public ThresholdOpenOpp(HashMap param,int buy)
	{
            this.params=param;
            this.buy=buy;
            this.paramCount=1;
