 ...
 * @author Admin
 */
public class SimpleChangeOpen extends  AbstractOpen
{
    public SimpleChangeOpen()
    {
        this.paramCount=1;
    }

    public SimpleChangeOpen(HashMap param,int buy)
    {
        this.buy=buy;
        this.paramCount=1;
        this.params=param;
            ...
            Filters filter)
    {
        ...
        for(int i=2;i<indList.getSize();i++)
        {
            ...
            {
                if(((buy==1 && indf.getValue()>=low+(low*pct*0.01) ) ||
