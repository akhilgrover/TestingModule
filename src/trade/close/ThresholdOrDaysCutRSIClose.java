...
public class ThresholdOrDaysCutRSIClose extends AbstractClose
{
    private boolean filterOpen;

    public ThresholdOrDaysCutRSIClose()
    {
        this.paramCount=4;
        filterOpen=false;
    }

    public ThresholdOrDaysCutRSIClose(HashMap param,int buy)
    {
        this.params=param;
        this.buy=buy;
        this.paramCount=4;
    ...
    public ThresholdOrDaysCutRSIClose(HashMap param, int buy, boolean filter)
    {
        this.params=param;
        this.buy=buy;
        this.paramCount=4;
                                    ...
                                    ShareList sl, Filters filter)
    {
        ...
        int rsiPeriod=((Double)params.get(2)).intValue();
        double thresholdSL=(Double) params.get(4);
        int days=0;
        ...
        hm.put(2, 1);
        rsi.init(hm);
        IndicatorList indListSL=rsi.buildIndicator(sl);
