 ...
 * @author Admin
 */
public class SimpleChangeDaysCutClose extends AbstractClose
{
    /**
     * 
     */
    public SimpleChangeDaysCutClose()
    {
        this.paramCount=2;
    }
     ...
     * @param buy
     */
    public SimpleChangeDaysCutClose(HashMap param, int buy)
    {
        this.buy=buy;
        this.params=param;
        this.paramCount=2;
