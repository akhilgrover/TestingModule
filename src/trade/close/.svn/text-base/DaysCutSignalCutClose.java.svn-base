 ...
 * @author Admin
 */
public class DaysCutSignalCutClose extends AbstractClose 
{
    boolean filterOpen;
    private static final long serialVersionUID = 1324568L;
    
    public DaysCutSignalCutClose()
    {
        this.paramCount=1;
        filterOpen=false;
    }
    
    public DaysCutSignalCutClose(int buy)
    {
        this.buy=buy;
        this.paramCount=1;
        filterOpen=false;
    ...
    public DaysCutSignalCutClose(HashMap param,int buy,boolean filter)
    {
        this.buy=buy;
        this.paramCount=1;
        filterOpen=filter;
    ...
    public DaysCutSignalCutClose(HashMap param,int buy)
    {
        this.buy=buy;
        this.paramCount=1;
        this.params=param;
