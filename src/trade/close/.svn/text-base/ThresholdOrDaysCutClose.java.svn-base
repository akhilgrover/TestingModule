...
public class ThresholdOrDaysCutClose extends AbstractClose
{
    boolean filterOpen;

    public ThresholdOrDaysCutClose()
    {
        this.paramCount=2;
        filterOpen=false;
    }

    public ThresholdOrDaysCutClose(HashMap param,int buy)
    {
        this.params=param;
        this.buy=buy;
        this.paramCount=2;
    ...
    public ThresholdOrDaysCutClose(HashMap param, int buy, boolean filter)
    {
        this.params=param;
        this.buy=buy;
        this.paramCount=2;
...
//                        endIndex=sl.isDatePresent(endDate);
	...
	public String toString()
	{
            ...
            //buffer.append(" Close ");
            if(filterOpen)
                buffer.append(" Close13 ");
            else
                buffer.append(" Close10 ");
