...
public class HighLimitDaysSLClose extends AbstractClose
{

    public HighLimitDaysSLClose()
    {
        this.paramCount=4;
    }

    public HighLimitDaysSLClose(HashMap param,int buy)
    {
        this.params=param;
        this.buy=buy;
        this.paramCount=4;
