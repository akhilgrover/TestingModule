...
public class HighLimitClose extends AbstractClose
{
    	
    public HighLimitClose()
    {
        this.paramCount=2;
    }

    public HighLimitClose(HashMap param,int buy)
    {
        this.params=param;
        this.buy=buy;
        this.paramCount=2;
                                    ...
                                    ShareList sl, Filters filter)
    {
            ...
            double thresholdsl=(Double) params.get(2); //stoploss
