 ...
 * @author Admin
 */
public class SimpleChangeClose extends AbstractClose
{
    /**
     * 
     */
    public SimpleChangeClose()
    {
        this.paramCount=1;
    }
     ...
     * @param buy
     */
    public SimpleChangeClose(HashMap param, int buy)
    {
        this.buy=buy;
        this.params=param;
        this.paramCount=1;
	...
	public String toString()
	{
            ...
            buffer.append("SimpleChange Close ");
